...
set ::env(CELL_PAD) "8"
set ::env(MERGED_LEF) "/project/openlane/morphle_yblock/runs/morphle_yblock/tmp/merged.lef"
set ::env(MERGED_LEF_UNPADDED) "/project/openlane/morphle_yblock/runs/morphle_yblock/tmp/merged_unpadded.lef"
set ::env(TRACKS_INFO_FILE) "/project/openlane/morphle_yblock/runs/morphle_yblock/tmp/tracks_copy.info"
set ::env(TECH_LEF) "/opt/asic/sky130A/libs.ref/sky130_fd_sc_hd/techlef/sky130_fd_sc_hd.tlef"
# Design config
set ::env(CLOCK_PERIOD) "0"
# Synthesis config
set ::env(LIB_SYNTH) "/project/openlane/morphle_yblock/runs/morphle_yblock/tmp/trimmed.lib"
